...
//------------------------------------operator()---------------------------------------
// call detect() and compute() functions
//Precondition: the following parameters must be correctly defined.
//parameters:
//image: color image
// TODO: This was added to comport with the features2D interface consider re-implementation.
//-------------------------------------------------------------------------------------
VanillaSIFT::detectAndCompute(InputArray image, InputArray mask, vector<KeyPoint> &keypoints, OutputArray descriptors,
